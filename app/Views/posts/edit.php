                ...
                <div class="card shadow">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?php if ($validation->getError('description')) : ?>is-invalid<?php endif ?>" name="description" placeholder="Description"><?php if ($post['description']) : echo $post['description'];
